...
$dataoptimize[10001][productindex][]=10;//文章列表的标识
$dataoptimize[10001][productindex10][]=all3;//查询标识为10的条件

$dataoptimize[10001][newsindex][]=3;//文章列表的标识index_num后台的栏目管理中的标识项
$dataoptimize[10001][newsindex3][]=0;//查询标识为3的条件
$dataoptimize[10001][newsindex][]=4;//文章列表的标识
$dataoptimize[10001][newsindex4][]=0;//查询标识为4的条件
$dataoptimize[10001][newsindex][]=20;//解决方案列表的标识
$dataoptimize[10001][newsindex20][]=0;//查询标识为20的条件

$dataoptimize[10001][imgindex][]=6;//成功案例
$dataoptimize[10001][imgindex6][]=0;//查询标识为6的条件
